...
hello.xe66: package/cfg/hello_pe66.oe66 
	...
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/hello_pe66.oe66   package/cfg/hello_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
...
xconfig_hello.tar: package/package.ext.xml
xconfig_hello.tar: package/package.rel.dot
xconfig_hello.tar: package/build.cfg
xconfig_hello.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_hello.tar.dep
endif
package/rel/xconfig_hello/xconfig_hello/package/package.rel.xml:
