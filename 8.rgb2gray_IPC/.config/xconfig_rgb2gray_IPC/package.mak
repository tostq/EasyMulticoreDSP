...
override PKGDIR = xconfig_rgb2gray_IPC
...
package/%.xdc.inc package/%_xconfig_rgb2gray_IPC.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_rgb2gray_IPC" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: rgb2gray_IPC.pe66

-include package/cfg/rgb2gray_IPC_pe66.mak
-include package/cfg/rgb2gray_IPC_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rgb2gray_IPC_pe66.dep
endif
rgb2gray_IPC.pe66: package/cfg/rgb2gray_IPC_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
rgb2gray_IPC.pe66 package/cfg/rgb2gray_IPC_pe66.c: .libraries,e66
endif

package/cfg/rgb2gray_IPC_pe66.c package/cfg/rgb2gray_IPC_pe66.h package/cfg/rgb2gray_IPC_pe66.xdl: override _PROG_NAME := rgb2gray_IPC.xe66
package/cfg/rgb2gray_IPC_pe66.c: package/cfg/rgb2gray_IPC_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/rgb2gray_IPC_pe66.cfg
	-$(RM) package/cfg/rgb2gray_IPC_pe66.dep
	-$(RM) package/cfg/rgb2gray_IPC_pe66.c
	-$(RM) package/cfg/rgb2gray_IPC_pe66.xdc.inc

clean,e66::
	-$(RM) rgb2gray_IPC.pe66
.executables,e66 .executables: rgb2gray_IPC.xe66

rgb2gray_IPC.xe66: |rgb2gray_IPC.pe66

-include package/cfg/rgb2gray_IPC.xe66.mak
rgb2gray_IPC.xe66: package/cfg/rgb2gray_IPC_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/rgb2gray_IPC_pe66.oe66   package/cfg/rgb2gray_IPC_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
rgb2gray_IPC.xe66: export C_DIR=
rgb2gray_IPC.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
rgb2gray_IPC.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

rgb2gray_IPC.test test,e66 test: rgb2gray_IPC.xe66.test

rgb2gray_IPC.xe66.test:: rgb2gray_IPC.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rgb2gray_IPC.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rgb2gray_IPC.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,rgb2gray_IPC.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) rgb2gray_IPC.xe66
clean:: 
	-$(RM) package/cfg/rgb2gray_IPC_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
rgb2gray_IPC_pe66.oe66,copy : package/cfg/rgb2gray_IPC_pe66.oe66
rgb2gray_IPC_pe66.se66,copy : package/cfg/rgb2gray_IPC_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_rgb2gray_IPC
xconfig_rgb2gray_IPC.tar: package/package.bld.xml
xconfig_rgb2gray_IPC.tar: package/package.ext.xml
xconfig_rgb2gray_IPC.tar: package/package.rel.dot
xconfig_rgb2gray_IPC.tar: package/build.cfg
xconfig_rgb2gray_IPC.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_rgb2gray_IPC.tar.dep
endif
package/rel/xconfig_rgb2gray_IPC/xconfig_rgb2gray_IPC/package/package.rel.xml:

xconfig_rgb2gray_IPC.tar: package/rel/xconfig_rgb2gray_IPC.xdc.inc package/rel/xconfig_rgb2gray_IPC/xconfig_rgb2gray_IPC/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_rgb2gray_IPC.xdc.inc,package/rel/xconfig_rgb2gray_IPC.tar.dep)


release release,xconfig_rgb2gray_IPC: all xconfig_rgb2gray_IPC.tar
clean:: .clean
	-$(RM) xconfig_rgb2gray_IPC.tar
	-$(RM) package/rel/xconfig_rgb2gray_IPC.xdc.inc
	-$(RM) package/rel/xconfig_rgb2gray_IPC.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_rgb2gray_IPC.pjt
