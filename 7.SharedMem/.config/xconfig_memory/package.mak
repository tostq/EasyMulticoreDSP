...
.dlls,e66 .dlls: memory.pe66

-include package/cfg/memory_pe66.mak
-include package/cfg/memory_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/memory_pe66.dep
endif
memory.pe66: package/cfg/memory_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
memory.pe66 package/cfg/memory_pe66.c: .libraries,e66
endif

package/cfg/memory_pe66.c package/cfg/memory_pe66.h package/cfg/memory_pe66.xdl: override _PROG_NAME := memory.xe66
package/cfg/memory_pe66.c: package/cfg/memory_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/memory_pe66.cfg
	-$(RM) package/cfg/memory_pe66.dep
	-$(RM) package/cfg/memory_pe66.c
	-$(RM) package/cfg/memory_pe66.xdc.inc

clean,e66::
	-$(RM) memory.pe66
.executables,e66 .executables: memory.xe66

memory.xe66: |memory.pe66

-include package/cfg/memory.xe66.mak
memory.xe66: package/cfg/memory_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/memory_pe66.oe66   package/cfg/memory_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/rts6600_elf.lib
	
memory.xe66: export C_DIR=
memory.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
memory.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

memory.test test,e66 test: memory.xe66.test

memory.xe66.test:: memory.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 memory.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.memory.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,memory.xe66,0,*
...
clean,e66::
	-$(RM) memory.xe66
clean:: 
	-$(RM) package/cfg/memory_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
memory_pe66.oe66,copy : package/cfg/memory_pe66.oe66
memory_pe66.se66,copy : package/cfg/memory_pe66.se66
...
xconfig_memory.tar: package/package.bld.xml
xconfig_memory.tar: package/package.ext.xml
xconfig_memory.tar: package/package.rel.dot
xconfig_memory.tar: package/build.cfg
xconfig_memory.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_memory.tar.dep
endif
package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml:
